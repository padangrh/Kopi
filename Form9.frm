...
Public Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
      ...
      Case 3
        ...
        Printer.Print Tab(2); "--------------------------------------------------";
        Printer.Print Tab(2); "Total: Rp. "; Format(priceToNum(Replace(FrmMain.Text1, ".", "")) + priceToNum(Replace(FrmMain.Text2, ".", "")), "###,###,##0");
        Printer.EndDoc
...
Private Sub lv_tunai_DblClick()
    If Not (lv_tunai.SelectedItem Is Nothing) Then
        ...
        form_Rekap.Show
        form_Rekap.kode_faktur = lv_tunai.SelectedItem.Text
        form_Rekap.temp_total = lv_tunai.SelectedItem.SubItems(3)
        form_Rekap.fill_List
    End If
End Sub
...
Private Sub lv_nontunai_DblClick()
    If Not (lv_nontunai.SelectedItem Is Nothing) Then
        ...
        form_Rekap.Show
        form_Rekap.kode_faktur = lv_nontunai.SelectedItem.Text
        form_Rekap.temp_total = lv_nontunai.SelectedItem.SubItems(3)
        form_Rekap.fill_List
