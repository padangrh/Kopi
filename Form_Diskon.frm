...
Begin VB.Form Form_Diskon 
   ...
   Begin VB.ComboBox cb_status 
      ...
      EndProperty
      Height          =   480
      ItemData        =   "Form_Diskon.frx":009A
      Left            =   2040
      List            =   "Form_Diskon.frx":00AD
      TabIndex        =   5
      Top             =   1440
      Width           =   2535
   End
...
Private Sub btn_ok_Click()
    ...
    If txt_diskon.Text = "" Then
        If cb_Diskon.Text <> "" Then
            Call cb_Diskon_KeyDown(13, 1)
        Else
            txt_diskon.Text = "0"
        End If
    End If
    ...
    ElseIf priceToNum(txt_diskon.Text) < 0 Then
        MsgBox "Diskon tidak boleh negatif"
    Else
...
Private Sub cb_Diskon_Click()
    If cb_Diskon.Text <> "" And IsNumeric(cb_Diskon.Text) = True Then
        txt_diskon.Text = priceToNum(Form_Print.txt_subTotal) * (cb_Diskon.Text / 100)
        txt_diskon = Format(txt_diskon, "###,###,##0")
    End If
End Sub

Private Sub cb_Diskon_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = 13 And cb_Diskon.Text <> "" And IsNumeric(cb_Diskon.Text) = True Then
        If CInt(cb_Diskon.Text) > 100 Or CInt(cb_Diskon.Text) < 0 Or IsNumeric(cb_Diskon.Text) = True Then
            MsgBox "Dilarang memberikan diskon lebih besar dari 100%"
        Else
            txt_diskon.Text = priceToNum(Form_Print.txt_subTotal) * (cb_Diskon.Text / 100)
            txt_diskon = Format(txt_diskon, "###,###,##0")
            btn_ok.SetFocus
...
Private Sub Form_Load()
    cb_Diskon.Text = cb_Diskon.List(0)
    cb_status.Text = cb_status.List(0)
End Sub
...
Private Sub txt_diskon_LostFocus()
    If IsNumeric(txt_diskon) = True Then txt_diskon = Format(txt_diskon, "###,###,##0") Else txt_diskon.Text = ""
End Sub
